...
export function DeleteAppointmentModal({ isOpen, appointment, onClose, onConfirm, isDeleting }: Props) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm">
      <div className="animate-in fade-in zoom-in w-full max-w-sm overflow-hidden rounded-2xl bg-white shadow-2xl duration-200">
        ...
        <div className="flex flex-col items-center p-6 text-center">
          ...
          <h2 className="text-xl font-bold text-gray-900">Excluir Atendimento</h2>
